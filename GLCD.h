...
extern void GLCD_BitmapFull   	(unsigned char *bitmap);
extern void GLCD_BitmapZoom     (unsigned int x_offset,  unsigned int y_offset,unsigned int zoom_factor, unsigned char *bitmap);
